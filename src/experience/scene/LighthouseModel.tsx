...
export function LighthouseModel(props: JSX.IntrinsicElements['group']) {
    ...
    const [
        ...
        'models/wasil_art.webp',
        'models/wasil_photo.webp',
        ...
        <group {...props} dispose={null} scale={0.3} rotation={[0, -Math.PI * 0.6, 0]}>
            ...
            >
                ...
                <canvasPhotosMaterial
                    ...
                    uArtTexture={wasilArtTexture}
                    uPhotoTexture={wasilPhotoTexture}
...
useTexture.preload('models/wasil_art.webp')
useTexture.preload('models/wasil_photo.webp')
